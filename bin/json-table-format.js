...
`, {
    importMeta: ({ url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('json-table-format.js', document.baseURI).href)) }),
    flags: {
        overwrite: {
            type: "boolean",
            default: false,
